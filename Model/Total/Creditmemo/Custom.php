 ...
 */
namespace Mageget\StoreCredit\Model\Total\Creditmemo;
 ...
 */
class Custom extends \Magento\Sales\Model\Order\Creditmemo\Total\AbstractTotal
{
    /**
     * @var Config
     */
    ...
    public function collect(\Magento\Sales\Model\Order\Creditmemo $creditmemo)
    {
        ...
        $totalDiscountAmount = $order->getStorecredit();
